...
export default () => {
  ...
  mainHandle<LX.Music.MusicInfo, string[]>(PLAYER_EVENT_NAME.list_music_get_list_ids, async ({ params: musicInfo }) => {
    return global.lx.worker.dbService.getMusicExistListIds(musicInfo)
  })
}
