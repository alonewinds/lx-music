...
export const watchConfigKeys = [
  ...
  'desktopLyric.effect.enable',
  'desktopLyric.effect.floatEnabled',
  'desktopLyric.effect.floatAmount',
  'desktopLyric.effect.scaleEnabled',
  'desktopLyric.effect.scaleAmount',
  'desktopLyric.effect.scaleLongSyllableDuration',
  'common.langId',
