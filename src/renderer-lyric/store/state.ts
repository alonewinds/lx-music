...
export const setting = shallowReactive<LX.DesktopLyric.Config>({
  ...
  'desktopLyric.effect.enable': false,
  'desktopLyric.effect.floatEnabled': false,
  'desktopLyric.effect.floatAmount': 8,
  'desktopLyric.effect.scaleEnabled': false,
  'desktopLyric.effect.scaleAmount': 1.15,
  'desktopLyric.effect.scaleLongSyllableDuration': 700,
  'desktopLyric.effect.glowAnimateEnabled': false,
  'common.langId': 'zh-cn',
